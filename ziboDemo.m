function ziboDemo(start_num, end_num)
addpath(genpath('.'));
...
%------------------------------------------------%
% % % Load Test Images
dir='/media/datadisk/database/';
image_path = strcat(dir,'AGAIN/');
saveLandmark_path=strcat(dir,'cropResult/landmarks/');
imglistPath=strcat(image_path,'img_list.txt');
